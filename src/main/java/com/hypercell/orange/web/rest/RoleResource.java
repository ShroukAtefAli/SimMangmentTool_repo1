...
import com.hypercell.orange.domain.Role;
import com.hypercell.orange.repository.RoleRepository;
...
/**
 * REST controller for managing {@link com.hypercell.orange.domain.Role}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class RoleResource {
    ...
    private static final String ENTITY_NAME = "simMangmentToolRole";
