package com.hypercell.orange.web.rest;
...
import com.hypercell.orange.IntegrationTest;
import com.hypercell.orange.domain.Users;
import com.hypercell.orange.repository.UsersRepository;
...
class UsersResourceIT {
    ...
    private static final Long DEFAULT_USER_DIAL = 1L;
    private static final Long UPDATED_USER_DIAL = 2L;
    ...
    void createUsers() throws Exception {
        ...
        assertThat(testUsers.getUserPassword()).isEqualTo(DEFAULT_USER_PASSWORD);
        assertThat(testUsers.getUserEmail()).isEqualTo(DEFAULT_USER_EMAIL);
        assertThat(testUsers.getUserDial()).isEqualTo(DEFAULT_USER_DIAL);
    }
    ...
    @Test
    @Transactional
    void checkUserDialIsRequired() throws Exception {
        int databaseSizeBeforeTest = usersRepository.findAll().size();
        // set the field null
        users.setUserDial(null);
    ...
    void getAllUsers() throws Exception {
        ...
        restUsersMockMvc
            ...
            .andExpect(jsonPath("$.[*].userDial").value(hasItem(DEFAULT_USER_DIAL.intValue())));
    }
    ...
    void getUsers() throws Exception {
        ...
        restUsersMockMvc
            ...
            .andExpect(jsonPath("$.userDial").value(DEFAULT_USER_DIAL.intValue()));
    }
    ...
    void putNewUsers() throws Exception {
        ...
        assertThat(testUsers.getUserPassword()).isEqualTo(UPDATED_USER_PASSWORD);
        assertThat(testUsers.getUserEmail()).isEqualTo(UPDATED_USER_EMAIL);
        assertThat(testUsers.getUserDial()).isEqualTo(UPDATED_USER_DIAL);
    }
    ...
    void partialUpdateUsersWithPatch() throws Exception {
        ...
        partialUpdatedUsers.userPassword(UPDATED_USER_PASSWORD).userDial(UPDATED_USER_DIAL);
