...
import com.hypercell.orange.domain.Customer;
import com.hypercell.orange.repository.CustomerRepository;
import com.hypercell.orange.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.hypercell.orange.domain.Customer}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class CustomerResource {
    ...
    private static final String ENTITY_NAME = "simMangmentToolCustomer";
    ...
    public ResponseEntity<Customer> partialUpdateCustomer(
        ...
        Optional<Customer> result = customerRepository
            ...
            .map(existingCustomer -> {
                ...
                if (customer.getContarctId() != null) {
                    existingCustomer.setContarctId(customer.getContarctId());
                }
                if (customer.getCustomerParent() != null) {
                    existingCustomer.setCustomerParent(customer.getCustomerParent());
                }
                if (customer.getDummyContract() != null) {
                    existingCustomer.setDummyContract(customer.getDummyContract());
                }
                if (customer.getCustomerIdHight() != null) {
                    existingCustomer.setCustomerIdHight(customer.getCustomerIdHight());
                }
