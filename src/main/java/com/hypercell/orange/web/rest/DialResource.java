...
import com.hypercell.orange.repository.DialRepository;
...
/**
 * REST controller for managing {@link com.hypercell.orange.domain.Dial}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class DialResource {
    ...
    private static final String ENTITY_NAME = "simMangmentToolDial";
