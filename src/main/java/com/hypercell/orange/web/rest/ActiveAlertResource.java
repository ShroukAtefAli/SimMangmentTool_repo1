...
import com.hypercell.orange.domain.ActiveAlert;
import com.hypercell.orange.repository.ActiveAlertRepository;
...
/**
 * REST controller for managing {@link com.hypercell.orange.domain.ActiveAlert}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ActiveAlertResource {
    ...
    private static final String ENTITY_NAME = "simMangmentToolActiveAlert";
