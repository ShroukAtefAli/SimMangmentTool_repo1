...
/**
 * REST controller for managing {@link com.hypercell.orange.domain.Users}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class UsersResource {
    ...
    private static final String ENTITY_NAME = "simMangmentToolUsers";
    ...
    public ResponseEntity<Users> partialUpdateUsers(
        ...
        Optional<Users> result = usersRepository
            ...
            .map(existingUsers -> {
                ...
                if (users.getUserDial() != null) {
                    existingUsers.setUserDial(users.getUserDial());
                }
