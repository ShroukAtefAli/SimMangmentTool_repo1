...
import com.hypercell.orange.domain.Alert;
import com.hypercell.orange.repository.AlertRepository;
...
/**
 * REST controller for managing {@link com.hypercell.orange.domain.Alert}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class AlertResource {
    ...
    private static final String ENTITY_NAME = "simMangmentToolAlert";
